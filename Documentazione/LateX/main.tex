...
\begin{itemize}[nosep]
  \item \textbf{RF-01 -- Registrazione utente}\\
...
\begin{itemize}[nosep]
  \item \textbf{L'applicazione Spring Boot} è deployata come container Docker sulla VM, garantendo l'isolamento dell'ambiente di esecuzione e la coerenza tra sviluppo e produzione.
  \item \textbf{PostgreSQL/PostGIS} è eseguito come container Docker sulla stessa VM. Questa scelta semplifica la gestione delle estensioni spaziali e facilita le operazioni di backup e aggiornamento.
